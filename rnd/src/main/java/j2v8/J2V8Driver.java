...
public class J2V8Driver {
	...
	public static void main(String[] args) throws InterruptedException, NodeException, ExecutionException {
		...
		j2v8MultiThreadedTest(script3, pathToScripts);
	...
	private static void j2v8LoadTest(String script, String pathToScripts) throws NodeException, InterruptedException, ExecutionException {
	...
	private static synchronized void singleScriptCall(String pathToScripts, String scriptName, String resourceType,
			String entityType, String attributeId) throws NodeException, InterruptedException, ExecutionException {
		J2V8ScriptEngine plugin = new J2V8ScriptEngine(pathToScripts, 1000);
	...
	private static synchronized void singleScriptCall(J2V8ScriptEngine engine, String scriptName, String resourceType, String entityType,
			String attributeId) {
