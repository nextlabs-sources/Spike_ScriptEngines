package com.nextlabs.scriptengines.node12trireme;
...
public class Node12TriremeDriver {

	public static void main(String[] args) throws NodeException, InterruptedException, ExecutionException {
		String pathToScripts = "C:\\Users\\lqin\\workspace\\ScriptEngines\\src\\main\\resources\\trireme_scripts\\Root";
	...
	private static void TriremeLoadTesting(String script, String pathToScripts)
		...
		Node12TriremeEngine engine = new Node12TriremeEngine(pathToScripts);
	...
	private static void TriremeMultiThreadingTest(String script, String pathToScripts)
		...
		final Node12TriremeEngine engine = new Node12TriremeEngine(pathToScripts);
