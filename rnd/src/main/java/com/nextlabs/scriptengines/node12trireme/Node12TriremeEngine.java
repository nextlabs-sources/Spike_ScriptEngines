...
//				sb.setFilesystemRoot("C:\\Users\\lqin\\workspace");
//				environment.setSandbox(sb);
				...
				TriremeReference reference = new TriremeReference(null, nodeScript, nodeModules, runtime, moduleResult);
