...
public class SynchronizedTriremeDriver {

	public static void main(String[] args) throws NodeException, InterruptedException, ExecutionException {
		String pathToScripts = "C:\\Users\\lqin\\workspace\\ScriptEngines\\src\\main\\resources";
		...
		//TriremeMultiThreadingTest(script2, pathToScripts);
	...
	private static void TriremeLoadTesting(String script, String pathToScripts)
		...
		SynchronnizedTriremeScriptEngine engine = new SynchronnizedTriremeScriptEngine(pathToScripts);
		for (int i = 0; i < 10; i++) {
			int index = i % 3;
			index = 3;
	...
	private static void TriremeMultiThreadingTest(String script, String pathToScripts)
		...
		final SynchronnizedTriremeScriptEngine engine = new SynchronnizedTriremeScriptEngine(pathToScripts);
